...
$(document).ready(function () {
    ...
    $("#report_date").on('change', function () {
        ...
        document.location.href = base_url + "/report/community_view_add?date=" + date + "&community_id=" + community_id;
    });

    $("#view_community").on('change', function () {
        var date = $("#report_date").val();
        // var get_date = $("#report_date").val();
    ...
    $("#save_btn").on('click', function () {
        ...
        else if ($("#inquiries_num").val() == 0) {
            errorAlert('Inquiry data is blanked');
        }
