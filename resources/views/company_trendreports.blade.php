                        ...
                        <td>
                            @foreach ($report_data as $report)
                                @if ($report->period_id == $period->id)
                                    ...
                                    @if ($report->inquiry > 0)
                                        @php
                                            $period_total += ($report->tours / $report->inquiry) * 100;
                                            $period_count++;
                                        @endphp
                                    @endif
                                @endif
                            ...
                            @if ($period_count != 0)
                                @php
                                    $total = ($total_tours / $total_inquiries) * 100;
                                    $count++;
                                @endphp
                    ...
                    <tr>
                        ...
                        <td>
                            @foreach ($report_data as $report)
                                @if ($report->period_id == $period->id)
                                    @php
                                        $total_deposit += $report->deposits;
                                        $total_tours += $report->tours;
                                    @endphp
                                    @if ($report->tours > 0)
                                        @php
                                            $period_total += 100 * ( $report->deposits / $report->tours);
                                            $period_count++;
                                        @endphp
                                    @endif
                                @endif
                            ...
                            @if ($total_tours != 0)
                                @php
                                    $total = ($total_deposit / $total_tours) * 100;
                                    $count++;
                                @endphp
                                {{ number_format($total, '2', '.', '') }}%
                            @endif
                        ...
                        <td>
                        @if ($total_tours != 0)
                            {{ number_format(($total_deposit / $total_tours) * 100, '2', '.', '') }}%
                        @else
                            0%
                        @endif
                        </td>
